...
public class FeatureLayerUtils {
  ...
  public enum _FieldType {
    ...
    public static _FieldType determineFieldType(Field field) {
  ...
  public static boolean setAttribute(Map<String, Object> attrs, Graphic oldGraphic, Field field, String value,
    ...
    if (_FieldType.determineFieldType(field) == _FieldType.STRING) {
    ...
    } else if (_FieldType.determineFieldType(field) == _FieldType.NUMBER) {
      ...
      if ( value.equals("") && oldGraphic.getAttributeValue(field.getName()) != Integer.valueOf(0))  {
        ...
        attrs.put(field.getName(), Integer.valueOf(0));
        hasValueChanged = true;
    ...
    } else if (_FieldType.determineFieldType(field) == _FieldType.DECIMAL) {
      ...
      if ( (value.equals("") && oldGraphic.getAttributeValue(field.getName()) != Double.valueOf(0))) {
        ...
        // set a null value on the new graphic
        attrs.put(field.getName(), Double.valueOf(0));
        hasValueChanged = true;
    ...
    } else if (_FieldType.determineFieldType(field) == _FieldType.DATE) {
